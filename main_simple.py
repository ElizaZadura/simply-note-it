...
class SimplyNoteIt:  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    """Tkinter-based text editor with multi-panel support."""
    ...
    def _panel_info(self):
        """Return panel indicator text for the window title."""
        if len(self.panels) > 1:
            return f" (Panel {self.current_panel + 1}/{len(self.panels)})"
        return ""
